...
\hypersetup{
pdftitle={WebScience Conference Proceedings Format},
pdfauthor={LaTeX},
pdfkeywords={WebScience, proceedings, archival format},
bookmarksnumbered,
pdfstartview={FitH},
colorlinks,
citecolor=black,
...
\title{WebScience Conference Proceedings Format}
...
WebSci Conference Proceedings, and this sample file
offers recommendations on writing for the worldwide
WebSci readership. Please review this document even if
you have submitted to WebSci conferences before, some
...
The WebScience conference is using a (slightly) version
is SIGCHI 2013 format. This format is to be used for submissions that are
...
for this document has the correct ACM WebSci copyright notice in place. 
...
The written and spoken language of WebSci is English. Spelling and
...
It is important that you write for the WebSci audience.  Please read
